...
class DeleteFriendActivityLogsBugIntegrationTest: BaseIntegration() {
    @Autowired
    ...
    @Order(1)
    @Test
    fun `given transaction and friend when delete friend fetches activity logs successfully`() {
